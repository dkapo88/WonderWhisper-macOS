  ...
  var body: some View {
    ScrollView {
      VStack(alignment: .leading, spacing: 20) {
        Text("Boost accuracy by teaching HermesWhisper about proper nouns, acronyms, and spelling preferences. Changes apply to both Dictation and Command modes.")
          .font(.subheadline)
          .foregroundStyle(.secondary)

        editorCard(
          title: "Custom vocabulary",
          subtitle: "Use a comma-separated list (e.g., \"HermesWhisper, WW, Groq, Parakeet\").",
          text: $vm.vocabCustom,
