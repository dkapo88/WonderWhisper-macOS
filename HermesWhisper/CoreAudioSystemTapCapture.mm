...
NSString *const HWSystemAudioTapErrorDomain = @"com.hermeswhisper.system-audio-tap";
...
- (instancetype)init {
  ...
  if (self != nil) {
    ...
    _deliveryQueue = dispatch_queue_create(
      "com.hermeswhisper.meeting.system-tap-delivery",
...
- (BOOL)startWithProcessIDs:(NSArray<NSNumber *> *)processIDs
  ...
  description.name = @"HermesWhisper meeting system audio";
  ...
  NSDictionary *aggregateDescription = @{
    @kAudioAggregateDeviceNameKey: @"HermesWhisper meeting audio",
