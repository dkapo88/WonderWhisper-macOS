...
final class ScreenContextService {
    private let backgroundQueue = DispatchQueue(label: "com.hermeswhisper.screencontext", qos: .utility)
    private let clipboardQueue = DispatchQueue(label: "com.hermeswhisper.screencontext.clipboard", qos: .userInitiated)
