...
/// unchanged, and a publish from the high-churn `MeetingCoordinator` re-entered the AppKit
/// `NSSegmentedControl` sizing path behind `.pickerStyle(.segmented)` — measured at
